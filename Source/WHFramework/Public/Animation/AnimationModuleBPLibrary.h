 ...
 */
UCLASS()
class WHFRAMEWORK_API UAnimationModuleBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	* @return void
	*/
	UFUNCTION(BlueprintCallable, meta=(Latent, LatentInfo= "LatentInfo", WorldContext= "WorldContextObject", BlendExp= "1.0", ApplicationTime= "1.0", ExpandEnumAsExecs= "MoveAction", AdvancedDisplay = "bEaseIn, bEaseOut, BlendExp, bForceShortestRotationPath", UnsafeDuringActorConstruction = "true"), Category="AnimationModuleBPLibrary")
	...
	* @return void
	*/
	UFUNCTION(BlueprintCallable, meta=(Latent, LatentInfo= "LatentInfo", WorldContext= "WorldContextObject", Duration="0.2", ExpandEnumAsExecs= "CancelableDelayAction", Keywords="sleep", UnsafeDuringActorConstruction = "true"), Category="AnimationModuleBPLibrary")
