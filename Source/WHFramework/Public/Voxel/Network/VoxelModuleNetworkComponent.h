...
protected:
	...
	void ClientReceive(const FVoxelRPCPacket& Packet);
...
private:
	...
	uint64 PendingInventoryEpoch = 0;
	uint64 LastRequestId = 0;
	uint64 NextOutboundId = 1;
	double LastHello = -10;
	double LastInterest = -10;
	double LastInventory = -10;
	double LastReceiveTick = 0;
	double EditTokens = 40;
	double PacketWindow = 0;
