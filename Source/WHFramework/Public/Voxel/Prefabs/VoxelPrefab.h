...
protected:
    ...
    UPROPERTY(Transient) TObjectPtr<UVoxelPrefabData> PreviewAsset;
    UPROPERTY(Transient) FVoxelPrefabSaveData PreviewData;
    UPROPERTY(Transient) double PreviewBlockSize = 100.0;
    UPROPERTY(Transient) TArray<TObjectPtr<UVoxelMeshComponent>> PreviewMeshes;
};
