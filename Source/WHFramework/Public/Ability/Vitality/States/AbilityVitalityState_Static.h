...
#include "AbilityVitalityState_Static.generated.h"

/**
 * 
 */
UCLASS()
class WHFRAMEWORK_API UAbilityVitalityState_Static : public UAbilityVitalityStateBase
{
	GENERATED_BODY()
