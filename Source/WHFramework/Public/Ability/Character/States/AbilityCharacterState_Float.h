...
#include "AbilityCharacterState_Float.generated.h"

/**
 * 
 */
UCLASS()
class WHFRAMEWORK_API UAbilityCharacterState_Float : public UAbilityCharacterStateBase
{
	GENERATED_BODY()
...
public:
	virtual float GetFloatOffsetPosZ() const;
};
