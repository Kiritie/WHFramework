...
#include "AbilityCharacterState_Climb.generated.h"

/**
 * 
 */
UCLASS()
class WHFRAMEWORK_API UAbilityCharacterState_Climb : public UAbilityCharacterStateBase
{
	GENERATED_BODY()
