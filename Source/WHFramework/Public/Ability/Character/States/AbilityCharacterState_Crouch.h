...
#include "AbilityCharacterState_Crouch.generated.h"

/**
 * 
 */
UCLASS()
class WHFRAMEWORK_API UAbilityCharacterState_Crouch : public UAbilityCharacterStateBase
{
	GENERATED_BODY()
