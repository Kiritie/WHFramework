...
#include "AbilityCharacterState_Swim.generated.h"

/**
 * 
 */
UCLASS()
class WHFRAMEWORK_API UAbilityCharacterState_Swim : public UAbilityCharacterStateBase
{
	GENERATED_BODY()
