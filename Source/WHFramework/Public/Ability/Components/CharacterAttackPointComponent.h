...
#include "CharacterAttackPointComponent.generated.h"
 ...
 */
UCLASS()
class WHFRAMEWORK_API UCharacterAttackPointComponent : public UBoxComponent, public IAbilityAttackerInterface
{
	GENERATED_BODY()
	
public:
	UCharacterAttackPointComponent(const FObjectInitializer& ObjectInitializer);
