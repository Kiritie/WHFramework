...
#include "AbilityTask_MoveSceneCompRelLocation.generated.h"
...
class WHFRAMEWORK_API UAbilityTask_MoveSceneCompRelLocation : public UAbilityTask
{
	...
	static UAbilityTask_MoveSceneCompRelLocation* MoveSceneComponentRelativeLocation(UGameplayAbility* OwningAbility, FName TaskInstanceName, USceneComponent* SceneComponent, FVector Location, float Duration, UCurveFloat* OptionalInterpolationCurve, UCurveVector* OptionalVectorInterpolationCurve);
