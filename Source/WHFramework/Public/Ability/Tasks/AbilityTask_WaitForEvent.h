...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FWaitForEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
...
public:
	...
	FWaitForEventDelegate EventReceived;
	 ...
	 *
	 * @param OwningAbility Owning ability to wait
