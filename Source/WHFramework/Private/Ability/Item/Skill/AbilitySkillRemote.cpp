...
void AAbilitySkillRemote::Initialize(AAbilityCharacterBase* InOwnerCharacter, const FName& InAbilitySkillIndex)
{
	Super::Initialize(InOwnerCharacter, InAbilitySkillIndex);
