...
#include UE_INLINE_GENERATED_CPP_BY_NAME(FallingMovementComponent)
...
void UFallingMovementComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
	...
	if(UKismetSystemLibrary::BoxTraceSingle(this, RayStart, RayEnd, Extents, GetOwner()->GetActorRotation(), UGlobalBPLibrary::GetGameTraceType(TraceChannel), false, {}, EDrawDebugTrace::None, HitResult, true))
	{
