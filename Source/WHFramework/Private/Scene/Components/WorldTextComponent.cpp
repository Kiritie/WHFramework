...
UWorldTextComponent::UWorldTextComponent()
{
	...
	static ConstructorHelpers::FClassFinder<UWidgetWorldText> NormalWorldTextClassFinder(TEXT("WidgetBlueprint'/WHFramework/Scene/Blueprints/Widget/WBP_WorldText_Normal.WBP_WorldText_Normal_C'"));
	if(NormalWorldTextClassFinder.Succeeded())
	{
		WorldTextMap.Add(EWorldTextStyle::Normal, NormalWorldTextClassFinder.Class);
	}

	static ConstructorHelpers::FClassFinder<UWidgetWorldText> StressWorldTextClassFinder(TEXT("WidgetBlueprint'/WHFramework/Scene/Blueprints/Widget/WBP_WorldText_Stress.WBP_WorldText_Stress_C'"));
