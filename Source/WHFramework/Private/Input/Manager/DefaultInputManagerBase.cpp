...
void UDefaultInputManagerBase::OnBindAction(UInputComponentBase* InInputComponent)
{
	...
	InInputComponent->BindInputAction(GameplayTags::InputTag_ZoomCamera, ETriggerEvent::Triggered, this, &UDefaultInputManagerBase::ZoomCamera, false);
	...
	InInputComponent->BindInputAction(GameplayTags::InputTag_MoveHPlayer, ETriggerEvent::Triggered, this, &UDefaultInputManagerBase::MoveHPlayer, false);
	InInputComponent->BindInputAction(GameplayTags::InputTag_MoveVPlayer, ETriggerEvent::Triggered, this, &UDefaultInputManagerBase::MoveVPlayer, false);
	...
	InInputComponent->BindInputAction(GameplayTags::InputTag_SystemOperation, ETriggerEvent::Started, this, &UDefaultInputManagerBase::SystemOperation, false);
}
...
void UDefaultInputManagerBase::MoveForwardCamera_Implementation(const FInputActionValue& InValue)
{
	...
	UCameraModule::Get().AddCameraMovementInput(Direction, InValue.Get<float>() * (UInputModuleStatics::GetKeyShortcut(GameplayTags::InputTag_CameraSprint).IsPressing(UCommonStatics::GetPlayerController()) ? 3.f : 1.f));
}
...
void UDefaultInputManagerBase::MoveUpCamera_Implementation(const FInputActionValue& InValue)
{
	...
	UCameraModule::Get().AddCameraMovementInput(FVector::UpVector, InValue.Get<float>() * (UInputModuleStatics::GetKeyShortcut(GameplayTags::InputTag_CameraSprint).IsPressing(UCommonStatics::GetPlayerController()) ? 3.f : 1.f));
}
