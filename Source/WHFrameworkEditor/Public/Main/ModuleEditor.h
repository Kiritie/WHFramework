...
class FModuleEditor : public FModuleEditorBase
{
...
private:
	...
	TSharedRef<class SDockTab> OnSpawnModuleEditorTab(const class FSpawnTabArgs& SpawnTabArgs);
 ...
 */
class FModuleBlueprintEditor : public FBlueprintEditor
{
public:
	/**
	...
	void InitModuleEditor(const EToolkitMode::Type Mode, const TSharedPtr<IToolkitHost>& InitToolkitHost, const TArray<UBlueprint*>& InBlueprints, bool bShouldOpenInDefaultsMode);
...
private:
	 ...
	 */
	void EnsureModuleBlueprintIsUpToDate(UBlueprint* Blueprint);

public:
	FModuleBlueprintEditor();

	virtual ~FModuleBlueprintEditor();
