 ...
 */
class FFiniteStateEditor : public FBlueprintEditor
{
public:
	/**
	...
	void InitFiniteStateEditor(const EToolkitMode::Type Mode, const TSharedPtr<IToolkitHost>& InitToolkitHost, const TArray<UBlueprint*>& InBlueprints, bool bShouldOpenInDefaultsMode);
...
private:
	 ...
	 */
	void EnsureFiniteStateBlueprintIsUpToDate(UBlueprint* Blueprint);

public:
	FFiniteStateEditor();

	virtual ~FFiniteStateEditor();
