...
#include "Global/K2Node/K2Node_FormatString.h"
...
/////////////////////////////////////////////////////
// UK2Node_FormatString

struct FFormatStringNodeHelper
{
...
const FName FFormatStringNodeHelper::FormatPinName(TEXT("Format"));
...
void UK2Node_FormatString::AllocateDefaultPins()
{
	...
	CachedFormatPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Text, FFormatStringNodeHelper::GetFormatPinName());
...
void UK2Node_FormatString::SynchronizeArgumentPinType(UEdGraphPin* Pin)
{
...
{
	return LOCTEXT("FormatString_Title", "Format String");
}
...
FName UK2Node_FormatString::GetUniquePinName()
{
	FName NewPinName;
	int32 i = 0;
	while (true)
...
void UK2Node_FormatString::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
	const FName PropertyName = (PropertyChangedEvent.Property ? PropertyChangedEvent.Property->GetFName() : NAME_None);
	if (PropertyName == GET_MEMBER_NAME_CHECKED(UK2Node_FormatString, PinNames))
	{
		ReconstructNode();
		GetGraph()->NotifyGraphChanged();
	}
...
void UK2Node_FormatString::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	*/
	...
	// Move connection of FormatString's "Result" pin to the call function's return value pin.
	CompilerContext.MovePinLinksToIntermediate(*FindPinChecked(TEXT("Result")), *CallConvertFunction->GetReturnValuePin());

	CallFormatFunction->GetReturnValuePin()->MakeLinkTo(CallConvertFunction->FindPinChecked(TEXT("InText")));
	
	
	// Move connection of FormatString's "Format" pin to the call function's "InPattern" pin
...
FText UK2Node_FormatString::GetArgumentName(int32 InIndex) const
{
...
void UK2Node_FormatString::AddArgumentPin()
{
...
void UK2Node_FormatString::RemoveArgument(int32 InIndex)
{
...
void UK2Node_FormatString::SetArgumentName(int32 InIndex, FName InName)
{
...
void UK2Node_FormatString::SwapArguments(int32 InIndexA, int32 InIndexB)
{
...
UEdGraphPin* UK2Node_FormatString::GetFormatPin() const
{
	if (!CachedFormatPin)
	{
		const_cast<UK2Node_FormatString*>(this)->CachedFormatPin = FindPinChecked(FFormatStringNodeHelper::GetFormatPinName());
	}
