...
public:
     ...
     * @return 打包是否成功
     */
    bool Pack(const FString& InZipFile, const FString& InOriginDirectory, const FString& InIgnoreFile = FString());
    /**
	 ...
	 * @return 打包是否成功
	 */
    bool Pack(const FString& InZipFile,const TArray<FString>& InOriginFiles, const FString& InRootDirectory = FString());
    /**
     * @brief 将指定文件解压到目标目录
     * @param InZipFile 
