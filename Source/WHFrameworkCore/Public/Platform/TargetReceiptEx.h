...
struct  FTargetReceiptEx
{
	...
	TArray<FBuildProductEx> BuildProducts;

	/** All the runtime dependencies that this target relies on */
	TArray<FRuntimeDependencyEx> RuntimeDependencies;

	/** Additional build properties passed through from the module rules */
	TArray<FReceiptPropertyEx> AdditionalProperties;
