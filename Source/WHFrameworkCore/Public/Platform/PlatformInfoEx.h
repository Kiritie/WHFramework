...
namespace PlatformInfoEx
{
	...
	struct FVanillaPlatformEntryEx
	{
		FVanillaPlatformEntryEx()
			: PlatformInfoEx(nullptr)
		{
		}

		FVanillaPlatformEntryEx(const FPlatformInfo* const InPlatformInfo)
			: PlatformInfoEx(InPlatformInfo)
		{
		}

		/** Information for this platform */
		const FPlatformInfo* PlatformInfoEx;
