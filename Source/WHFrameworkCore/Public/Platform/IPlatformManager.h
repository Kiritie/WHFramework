...
public:
	...
	*/
	UE_DEPRECATED(4.24, "The IPlatformManager::GetSolutionPath() method has been deprecated. Use the ISourceCodeAccessor interface for cross-IDE support instead.")
