 ...
 */
class FWindowsNativeFeedbackContextEx : public FFeedbackContext
{
public:
	// Constructor.
	FWindowsNativeFeedbackContextEx();
	virtual ~FWindowsNativeFeedbackContextEx();
...
private:
	...
	{
		FWindowsNativeFeedbackContextEx* Context;
		int32 ScaleX;
		int32 ScaleY;
		int32 StandardW;
		int32 StandardH;
