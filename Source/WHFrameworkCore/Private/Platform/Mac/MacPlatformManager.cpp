...
#include "MacNativeFeedbackContextEx.h"
...
@end
const FUniqueType FMacPlatformManager::Type = FPlatformManager::Type;

//////////////////////////////////////////////////////////////////////////
// FMacPlatformManager
IMPLEMENTATION_MANAGER(FMacPlatformManager)

// Sets default values
FMacPlatformManager::FMacPlatformManager()
{
}
...
void FMacPlatformManager::OnInitialize()
{
	FManagerBase::OnInitialize();
}

void FMacPlatformManager::OnTermination()
{
	FManagerBase::OnTermination();
}

bool FMacPlatformManager::OpenFileDialog(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames)
{
	int32 DummyIdx = 0;
...
bool FMacPlatformManager::OpenFileDialog(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames, int32& OutFilterIndex)
{
...
bool FMacPlatformManager::SaveFileDialog(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames)
{
	int32 DummyIdx = 0;
...
bool FMacPlatformManager::OpenDirectoryDialog(const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, FString& OutFolderName)
{
...
bool FMacPlatformManager::OpenFontDialog(const void* ParentWindowHandle, FString& OutFontName, float& OutHeight, EFontImportFlags& OutFlags)
{
	MacApplication->SetCapture( NULL );
...
bool FMacPlatformManager::FileDialogShared(bool bSave, const void* ParentWindowHandle, const FString& DialogTitle, const FString& DefaultPath, const FString& DefaultFile, const FString& FileTypes, uint32 Flags, TArray<FString>& OutFilenames, int32& OutFilterIndex)
{
	MacApplication->SetCapture( NULL );
...
bool FMacPlatformManager::RegisterEngineInstallation(const FString &RootDir, FString &OutIdentifier)
{
	bool bRes = false;
...
void FMacPlatformManager::EnumerateEngineInstallations(TMap<FString, FString> &OutInstallations)
{
	SCOPED_AUTORELEASE_POOL;
...
bool FMacPlatformManager::VerifyFileAssociations()
{
...
bool FMacPlatformManager::UpdateFileAssociations()
{
...
bool FMacPlatformManager::RunUnrealBuildTool(const FText& Description, const FString& RootDir, const FString& Arguments, FFeedbackContext* Warn, int32& OutExitCode)
{
	OutExitCode = 1;
...
bool FMacPlatformManager::IsUnrealBuildToolRunning()
{
...
FFeedbackContext* FMacPlatformManager::GetNativeFeedbackContext()
{
	static FMacNativeFeedbackContext Warn;
	return &Warn;
}

FString FMacPlatformManager::GetUserTempPath()
{
